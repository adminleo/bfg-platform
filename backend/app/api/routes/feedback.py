...
async def create_round(data: CreateFeedbackRoundRequest, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
...
async def list_rounds(user_id: uuid.UUID, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
...
async def get_round(round_id: uuid.UUID, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
...
async def add_raters(round_id: uuid.UUID, data: AddRatersRequest, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
...
async def launch_round(round_id: uuid.UUID, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
...
async def get_results(round_id: uuid.UUID, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
